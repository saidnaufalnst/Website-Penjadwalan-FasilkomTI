...
const Login = () => {
  ...
  return (
    <div className="flex justify-center h-screen items-center">
      <div className="App w-[450px] py-6 px-8 bg-white border border-gray-200 rounded-md shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <form onSubmit={loginHandler}>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            <div className="col-start-1 col-end-3 flex">
              ...
              <label htmlFor="ingat-saya" className=" ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Ingat saya</label>
            </div>
          ...
          <button type="submit" className=" w-full text-white bg-[#03965C] hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
            Masuk
          </button>
          
          <div className="text-center mt-6 mb-4">
            <p className="text-sm ">Belum punya akun? <Link to="/register" className="text-blue-600 hover:underline dark:text-blue-500">Daftar di sini</Link></p>
          </div>
        </form>
      </div>
    </div>
